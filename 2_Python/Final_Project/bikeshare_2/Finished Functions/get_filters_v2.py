...
# this doesn't loop around to check if the follow-up response was valid or not 
# (y) or (n)
# thus see get_filters_fin for finished updated version! 
...
def get_filters():
    ...
    while True: 
        ...
        if city not in ("chicago", "new york city", "washington"):
            ...
            validity = str(input("Is that correct? Type 'y' to continue and 'n' to restart: \n").strip().lower())
            if validity == 'y':
                break
            else: 
                get_filters()
    ...
    while True:
        ...
        if month not in ("january", "february", "march", "april", "may", "june", "all"):
            ...
            validity_m = str(input("Is that correct? Type 'y' to continue and 'n' to restart: \n").strip().lower())
            if validity_m == 'y':
                break
            else: 
                get_filters()
    ...
    while True:
        ...
        if day not in ("monday", "tuesday", "wednesday", "thursday", "friday", "saturday" , "sunday", "all"):
            ...
            validity_d = str(input("Is that correct? Type 'y' to continue and 'n' to restart: \n").strip().lower())
            if validity_d == 'y':
                break
            else: 
                get_filters()
